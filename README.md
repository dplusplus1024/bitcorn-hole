...
2. **Microcontroller Code**: This is the code that runs on the microcontrollers, hosting a web server and interfacing with the ToF sensors to detect when a beanbag is present.
